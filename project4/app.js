...
addButton.addEventListener("click", () => {
  ...
  var opt1_1 = document.createElement("option");
  opt1_1.setAttribute("value", "A+");
  let textNode1_1 = document.createTextNode("A+");
  opt1_1.appendChild(textNode1_1);
...
function handleSorting(direction) {
  ...
  allInputs.innerHTML = "";  // empty string 代表清空內容
  ...
  for (let i = 0; i < graders.length; i++) {
    graders[i].children[3].value = objectArray[i].class_grade;   // class_grade是一個array
  }
